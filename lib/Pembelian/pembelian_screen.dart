...
import 'package:ruang_loak/Pembelian/PembelianService.dart';
...
class _PembelianScreenState extends State<PembelianScreen> {
  ...
  var _penawaranController = TextEditingController();
  ...
  getAllPembelian() async {
    ...
    pembelians.forEach((pembelian) {
      setState(() {
        ...
        pembelianModel.penawaran = pembelian['penawaran'];
  ...
  editPembelian(BuildContext, pembelianId) async {
    ...
    setState(() {
      ...
      _penawaranController.text = pembelian[0]['penawaran'] ?? 'Tidak ada penawaran';
    });
    editdialog(context);
  }
                ...
                child: Container(
                    ...
                    child: TextButton(
                        onPressed: () async {
                          ...
                          _pembelian.penawaran = _penawaranController.text;
              ...
              child: Column(
                children: <Widget>[
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(hintText: 'Penawaran', labelText: 'Penawaran'),
                  ),
                ],
              ),
            ),
